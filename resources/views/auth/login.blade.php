                    ...
                    <div class="login-body card-body">
                        <from method="post" action="{{route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-sm-4 col-form-laravel text-md-right">{{__('messages.email') }}</label>

                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control{{ $errors->has('email')?' is-invalid' : '' }}" name="email" value="{{ old('email')}}" required autofocas>
